...
export default function Shop() {
  ...
  useEffect(() => {
    const handler = (e) => {
      ...
      // Fix image paths to work properly
      ...
      console.log('Extracted product data:', { id, name, price: priceNum, image });
  ...
  return (
    <div ref={rootRef}>
      ...
      <div className="text-center m-5 ">
        <h2 className="fw-bolder fs-1">Featured Products</h2>
      </div>

      <section id="product1" className="px-3">
        <div className="text-center my-5 ">
          <h2 className="fw-bolder">New Arrivals</h2>
      ...
      <section id="product1" className="px-3 electronics">
      ...
      <section id="product1" className="px-3 electronics2">
        <div className="pro-container">
          <div className="pro">
      ...
      <section id="product1" className="px-3 electronics3">
        <div className="pro-container">
          <div className="pro">
